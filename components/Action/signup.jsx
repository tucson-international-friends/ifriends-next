	...
	return <>
		<Modal show={modalOpen} onHide={() => setModalOpen(false)}>
			...
			<Modal.Body>
				...
				<Button block size="lg" label="Student" onClick={handleStudentApplication} />
				<Button block size="lg" label="Host" onClick={handleHostApplication} />
			</Modal.Body>
		...
		{user
			...
			: (
				<Button variant="important" onClick={() => setModalOpen(true)} size={size} label={label} />
			)
		}
	</>;
};
